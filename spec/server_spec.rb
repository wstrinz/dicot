...
describe 'Dicot Server' do
  ...
  describe "classify" do
    ...
    before(:all) do
      Dicot.model.classifier.train(@classify_string, @classify_expect)
    end
  ...
  describe "feedback queue" do
    ...
    it "update" do
      ...
      expect(Dicot.model.tagger.feedback_queue).to eq alt_queue
    end
  ...
  describe "submit to training queue" do
    ...
    it do
      ...
      expect(Dicot.model.tagger.training_queue.last).to eq expected_training_queue
    end
  end
  ...
  describe "autocomplete word lists" do
    it "classes" do
      get "/list_classes"
      expect(last_response.body).to eq Dicot.model.classifier.labels.to_a.to_json
    end

    it "tags" do
      get "/list_tags"
      expect(last_response.body).to eq Dicot.model.tagger.labels.to_json
    end
  end
end
